...
CREATE TABLE Compuesto (
    ...
    plan1 int NOT NULL,
    Plan_id_plan int NOT NULL,
    CONSTRAINT Compuesto_pk PRIMARY KEY (Plan_id_plan)
);
...
-- Reference: Compuesto_Plan (table: Compuesto)
ALTER TABLE Compuesto ADD CONSTRAINT Compuesto_Plan FOREIGN KEY Compuesto_Plan (Plan_id_plan)
    REFERENCES Plan (id_plan);
